...
from app.api.v1 import auth, users, university, academics, faculty, attendance, lms, examination, finance, infrastructure, corporate, communication, analytics, security
